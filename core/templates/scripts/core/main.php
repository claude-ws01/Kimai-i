...
<head>
    ...
    <title><?php echo isset($this->kga['user']) ? $this->escape($this->kga['user']['name'])
            : $this->escape($this->kga['customer']['name']) ?> - Kimai</title>
    <link rel="shortcut icon" type="image/x-icon" href="../favicon.ico">

    <!-- Default Stylesheets -->
    <link rel="stylesheet" href="../skins/<?php echo $this->escape($this->kga['conf']['skin']); ?>/styles.css"
          type="text/css" media="screen" title="no title" charset="utf-8"/>
    <link rel="stylesheet" type="text/css"
          href="../skins/<?php echo $this->escape($this->kga['conf']['skin']); ?>/jquery.jqplot.css"/>
    <!-- /Default Stylesheets -->
    ...
    <!--[if IE]>
    <script src="../libraries/jQuery/excanvas.min.js" type="text/javascript"></script><![endif]-->
...
<div id="top">
    ...
    <div id="logo">
        <img src="../skins/<?php echo $this->escape($this->kga['conf']['skin']) ?>/grfx/g3_logo.png" width="151"
             height="52" alt="Logo"/>
    </div>

    <div id="menu">
        <a id="main_logout_button" href="../index.php?a=logout"><img
                src="../skins/<?php echo $this->escape($this->kga['conf']['skin']) ?>/grfx/g3_menu_logout.png"
                width="36" height="27" alt="Logout"/></a>
    ...
    <div id="display">
        ...
        <div id="infos">
            <span id="n_date"></span> &nbsp;
            <img src="../skins/<?php echo $this->escape($this->kga['conf']['skin']) ?>/grfx/g3_display_smallclock.png"
                 width="13" height="13" alt="Display Smallclock"/>
            <span id="n_uhr">00:00</span> &nbsp;
            <img src="../skins/<?php echo $this->escape($this->kga['conf']['skin']) ?>/grfx/g3_display_eye.png"
...
<div class="lists" style="display:none">
    ...
    <div id="projects_foot">
        <?php if ($this->show_project_add_button): ?>
            <a href="#" class="addLink"
               onclick="floaterShow('floaters.php','add_edit_project',0,0,650); $(this).blur(); return false;"></a>
        <?php endif; ?>
        <a href="#" class="selectAllLink"
    ...
    <div id="activities_foot">
        <?php if ($this->show_activity_add_button): ?>
            <a href="#" class="addLink"
               onclick="floaterShow('floaters.php','add_edit_activity',0,0,450); $(this).blur(); return false;"></a>
        <?php endif; ?>
        <a href="#" class="selectAllLink"
