        ...
        foreach ($projects as $project) {
            ...
            <tr id="row_project" data-id="<?php echo $project['projectID'] ?>"
                ...
                <td style="white-space: nowrap" class="option">
                    ...
                    <?php if ($this->show_project_edit_button): ?>
                        <a href="#"
                           onclick="editSubject('project',<?php echo $project['projectID'] ?>); $(this).blur(); return false;">
                            <img src='../skins/<?php echo $this->escape($this->kga['conf']['skin']) ?>/grfx/edit2.gif'
                    ...
                    <a href="#"
                       onclick="lists_update_filter('project',<?php echo $project['projectID'] ?>); $(this).blur(); return false;">
                        <img src='../skins/<?php echo $this->escape($this->kga['conf']['skin']) ?>/grfx/filter.png'
                    ...
                    <a href="#" class="preselect"
                       ...
                       id="ps<?php echo $project['projectID'] ?>">
                        <img
                            src='../skins/<?php echo $this->escape($this->kga['conf']['skin']) ?>/grfx/preselect_off.png'
                            width='13' height='13' alt='<?php echo $this->kga['lang']['select'] ?>'
                ...
                <?php if ($this->kga['conf']['flip_project_display']): ?>
                    ...
                    <?php endif; ?>
                    <span
                        class="lighter"><?php echo $this->escape($this->truncate($project['customerName'], 30, '...')) ?>
