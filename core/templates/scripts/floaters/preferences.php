...
<div id="floater_innerwrap">
    ...
    <div id="floater_handle">
        <span id="floater_title"><?php echo $kga['lang']['preferences'] ?></span>
    ...
    <div class="menuBackground">
        ...
        <ul class="menu tabSelection">
            ...
            <li class="tab norm"><a href="#prefList">
                    <span class="aa">&nbsp;</span>
                    <span class="bb"><?php echo $kga['lang']['list'] ?></span>
                    <span class="cc">&nbsp;</span>
                </a>
            </li>
            <li class="tab norm"><a href="#prefSublists">
                    <span class="aa">&nbsp;</span>
                    <span class="bb"><?php echo $kga['lang']['sublists'] ?></span>
                    <span class="cc">&nbsp;</span>
                </a>
            </li>
        </ul>
    ...
    <form id="core_prefs" action="processor.php" method="post">
        ...
        <div id="floater_tabs" class="floater_content">
            ...
            <fieldset id="prefGeneral">
                <ul>
                    <li>
                        <label for="skin"><?php echo $kga['lang']['skin'] ?>
                            :</label><?php echo $this->formSelect('skin', $kga['pref']['skin'], null, $this->skins); ?>
                    </li>

                    <li>
                        <label for="password"><?php echo $kga['lang']['newPassword'] ?>:</label>
                        <input name="password" size="15"
                               id="password"/> <?php echo $kga['lang']['minLength'] ?>
                    </li>

                    <li>
                        <label for="retypePassword"><?php echo $kga['lang']['retypePassword'] ?>:</label>
                        <input name="retypePassword" size="15" id="retypePassword"/>
                    </li>

                    <?php if (!array_key_exists('customer', $kga)) { ?>
                        <li>
                           <label for="rate"><?php echo $kga['lang']['my_rate'] ?>:</label>
                    ...
                    <li>
                        <label for="language"><?php echo $kga['lang']['lang'] ?>:</label>
                        <?php echo $this->formSelect('language', $kga['pref']['language'], null, $this->langs); ?>
                    </li>

                    <li>
                        <label for="timezone"><?php echo $kga['lang']['timezone'] ?>:</label>
            ...
            <fieldset id="prefList">
                <ul>
                    <li>
                        <label for="rowlimit"><?php echo $kga['lang']['rowlimit'] ?>:</label>
                        <?php echo $this->formText('rowlimit', $kga['pref']['rowlimit'], array('size' => 9)); ?>
                    </li>
                    <?php if (!array_key_exists('customer', $kga)) { ?>
                    <li>
                        <label for="quickdelete"><?php echo $kga['lang']['quickdelete'] ?>:</label>
                        <?php
                    ...
                    <li>
                        ...
                        <?php echo $this->formCheckbox('hide_cleared_entries', '1', array('checked' => $kga['pref']['hide_cleared_entries'])), $kga['lang']['hide_cleared_entries'] ?>
                    </li>
                    <li>
                        ...
                        echo $kga['lang']['show_comments_by_default'] ?>
                    </li>
                    <li>
                        <label for="show_ref_code"></label>
                        <?php echo $this->formCheckbox('show_ref_code', '1', array('checked' => isset($kga['conf']['show_ref_code']) && $kga['conf']['show_ref_code'])), $kga['lang']['show_ref_code'] ?>
                    </li>
                    <li>
                        <label for="hide_overlap_lines"></label>
                        <?php echo $this->formCheckbox('hide_overlap_lines', '1', array('checked' => isset($kga['conf']['hide_overlap_lines']) && $kga['conf']['hide_overlap_lines'])), $kga['lang']['hide_overlap_lines'] ?>
                    </li>
                </ul>
            </fieldset>
            ...
            <fieldset id="prefSublists">
                <ul>
                    <li>
                        <label for="sublist_annotations"><?php echo $kga['lang']['sublist_annotations'] ?>:</label>
                        <?php 
                        echo $this->formSelect(
                            'sublist_annotations', 
