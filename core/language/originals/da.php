...
"status"            => "Status",
"admin_mail"         => "administrators emailadresse",
"login_tries"        => "Antal loginfejl, inden bruger blokeres",
...
"yes"               => "ja",
"no"                => "nej",
"comment_type"      => "Type af kommentar",
"ctype0"            => "Kommentar",
"ctype1"            => "Bemærkning",
"ctype2"            => "Advarsel!",
"hint"              => "Hint:",
...
'show_day_separator_lines' => 'Vis en linie mellem posteringer på forskellige dage.',
'show_gab_breaks' => 'Vis en linie mellem to posteringer, der ikke er i umiddelbar forlængelse af hinanden.',
'show_record_again' => 'Vis &quot;Registrer igen&quot; foran alle posteringer.',
'ref_num_editable' => 'Tillader at redigere feltet Trackingnummer.',
...
'duration_with_seconds' => 'Vis eksakt varighed ned til sekunder.',
...
'timezone' => 'tidszone',
'ud_timezone' => 'tidszone for nye brugere og kunder',

'hide_cleared_entries' => 'skjul fjernede posteringer',
...
'exact_sums' => 'Brug eksakte værdier i stedet for at summere afrundede værdier.',
...
'credits' => <<<EOF
        Torsten H&ouml;ltge, Severin Leonhardt, Kevin Papst, Oleg Britvin, Martin Klemkow og andre...<br />
        
        <br />
        
        <strong>Dette program er Fri Software og stillet til rådighed som den forefindes uden nogen form for garanti</strong> under vilkårene i 
        ...
        <strong>Særlig tak</strong> til alle betatestere, som er for talrige til at nævne - I ved, hvem I er! ;)<br /><br />

        Fakturaudvidelsen anvender PclZip-biblioteket, som kan findes på <a href="http://www.phpconcept.net" rel="nofollow">http://www.phpconcept.net</a>.<br/><br/>

        Version 0.8 blev udviklet med venlig støtte fra RRZE (Regionales Rechenzentrum Erlangen).<br /><br />
        <br />
EOF
,
