...
"budget_minus"		=> "预算超支",
"wage"              => "工资",
"round_timesheet_entries" => "新计时条目图",
"minutes"			=> "分钟",
"seconds" 			=> "秒",
"and" 				=> "和",
"customerlogin"     => "客户登录",
...
'show_day_separator_lines' => '每日数据之间绘画一条分割线.',
'show_gab_breaks' => '在两条不完整的数据记录间绘画一条分割线.',
'show_record_again' => '粗体显示重复数据.',
'ref_num_editable' => '允许编辑跟踪数据.',
...
'duration_with_seconds' => '持续时间精确到秒.',
...
'timezone' => '时区',
'ud_timezone' => '默认新账户和客户时区',
'editLimitPart1' => '没有条目可以被添加或修改.',
'editLimitPart2' => '天 和',
'editLimitPart3' => '已用小时数.',
'editLimitError' => '结束日期要在将来的某一时刻.',

'hide_cleared_entries' => '隐藏清除条目',
'show_comments_by_default' => '默认显示评论',
'hide_overlap_lines' => '隐藏时间重叠的条目',
...
'exact_sums' => '不应该使用四舍五入后的数值，应该使用精确数值.',
