...
if ($_REQUEST['language'] === 'en') {
    ...
    <h2>System Requirements</h2>The following conditions must be met:<br/>

    <div class="sp_phpversion fail">at least PHP Major version 5.3</div><?php if ($checkMagicQuotes) { ?>
        <div class="sp_magicquotes">Magic Quotes must be disabled.</div>
        <div class="note gray">The PHP settings magic_quotes_gpc and magic_quotes_runtime must be set to off.
        </div><?php } ?>
    <div class="sp_mysql">The <b>MySQL</b> extension for PHP has to be loaded.</div>

    <br/><br/>For PDF export the following requirement must be met:<br/>
    ...
    <h2>Systemanforderungen</h2>Die folgenden Punkte m&uuml;ssen erf&uuml;llt sein:<br/>

    <div class="sp_phpversion fail">mindestens PHP Hauptversion 5.3</div><?php if ($checkMagicQuotes) { ?>
        <div class="sp_magicquotes">Magic Quotes müssen deaktiviert sein.</div>
        <div class="note gray">Die PHP Einstellungen magic_quotes_gpc und magic_quotes_runtime müssen auf off gestellt
                               sein.
        </div><?php } ?>
    <div class="sp_mysql">Die <b>MySQL</b> Erweiterung f&uuml;r PHP muss aktiviert sein.</div>

    <br/><br/>Damit der PDF Export zuverl&auml;ssig funktioniert m&uuml;ssen folgende Punkte erf&uuml;llt sein:<br/>
