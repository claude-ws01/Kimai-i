...
function export_extension_set_tableWrapperWidths() {
    ...
    $("#xpo_head,#xpo_main").css("width", export_width);
...
function export_extension_set_heightTop() {
    ...
    if (!extensionShrinkMode) {
        $("#xpo_main").css("height", export_height);
    } else {
...
function export_extension_set_TableWidths() {
    var xp_table = $("#xpo_main > table");

    export_extension_get_dimensions();

    ($("#xpo_main").innerHeight() - xp_table.outerHeight() > 0) ? scr = 0 : scr = scroller_width; // width of export table depending on scrollbar or not
    // xp_table.css("width", export_width - scr);

    $("#xpo_head > table").css("width", export_width - scr);

    // manage width of DATA column
    $("#xpo_head > table > tbody > tr > td.date").css("width", $("div#xpo_main > div > table > tbody > tr > td.date").width());
    $("#xpo_head > table > tbody > tr > td.from").css("width", $("div#xpo_main > div > table > tbody > tr > td.from").width());
    $("#xpo_head > table > tbody > tr > td.to").css("width", $("div#xpo_main > div > table > tbody > tr > td.to").width());
    $("#xpo_head > table > tbody > tr > td.time").css("width", $("div#xpo_main > div > table > tbody > tr > td.time").width());
    $("#xpo_head > table > tbody > tr > td.dec_time").css("width", $("div#xpo_main > div > table > tbody > tr > td.dec_time").width());
    $("#xpo_head > table > tbody > tr > td.rate").css("width", $("div#xpo_main > div > table > tbody > tr > td.rate").width());
    $("#xpo_head > table > tbody > tr > td.wage").css("width", $("div#xpo_main > div > table > tbody > tr > td.wage").width());
    $("#xpo_head > table > tbody > tr > td.budget").css("width", $("div#xpo_main > div > table > tbody > tr > td.budget").width());
    $("#xpo_head > table > tbody > tr > td.approved").css("width", $("div#xpo_main > div > table > tbody > tr > td.approved").width());
    $("#xpo_head > table > tbody > tr > td.status").css("width", $("div#xpo_main > div > table > tbody > tr > td.status").width());
    $("#xpo_head > table > tbody > tr > td.billable").css("width", $("div#xpo_main > div > table > tbody > tr > td.billable").width());
    $("#xpo_head > table > tbody > tr > td.customer").css("width", $("div#xpo_main > div > table > tbody > tr > td.customer").width());
    $("#xpo_head > table > tbody > tr > td.project").css("width", $("div#xpo_main > div > table > tbody > tr > td.project").width());
    $("#xpo_head > table > tbody > tr > td.activity").css("width", $("div#xpo_main > div > table > tbody > tr > td.activity").width());
    $("#xpo_head > table > tbody > tr > td.description").css("width", $("div#xpo_main > div > table > tbody > tr > td.description").width());
    $("#xpo_head > table > tbody > tr > td.moreinfo").css("width",
        $("div#xpo_main > div > table > tbody > tr > td.comment").width() +
            $("div#xpo_main > div > table > tbody > tr > td.location").width() +
            $("div#xpo_main > div > table > tbody > tr > td.trackingNumber").width()
    );
    $("#xpo_head > table > tbody > tr > td.user").css("width", $("div#xpo_main > div > table > tbody > tr > td.user").width());
}
...
function export_extension_reload() {
    ...
    $.post(export_extension_path + "processor.php", { axAction: "reload", axValue: filterUsers.join(":") + '|' + filterCustomers.join(":") + '|' + filterProjects.join(":") + '|' + filterActivities.join(":"),
        ...
        function (data) {
            ...
            ($("#xpo_main").innerHeight() - $("#xpo_main table").outerHeight() > 0 ) ? scr = 0 : scr = scroller_width; // width of export table depending on scrollbar or not
            $("#xpo_main table").css("width", export_width - scr);
...
function export_toggle_column(name) {
    if ($("#xpo_head > table > tbody > tr ." + name).hasClass('disabled')) {
        returnfunction = new Function("data", "if (data!=1) return;\
                    $('#xpo_head > table > tbody > tr ." + name + "').removeClass('disabled');\
                    $('div#xpo_main > div > table > tbody > tr > td." + name + "').removeClass('disabled'); ");
        ...
        returnfunction = new Function("data", "if (data!=1) return;\
                    $('#xpo_head > table > tbody > tr ." + name + "').addClass('disabled'); \
                    $('div#xpo_main > div > table > tbody > tr > td." + name + "').addClass('disabled'); ");
        $.post(export_extension_path + "processor.php", { axAction: "toggle_header", axValue: name },
            returnfunction
        );
    }
...
function export_enabled_columns() {
    ...
    $(columns).each(function () {
        if (!$('#xpo_head .' + this).hasClass('disabled')) {
