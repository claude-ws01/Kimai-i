...
<div id="floater_innerwrap">
    ...
    <div id="floater_handle">
        <span id="floater_title"><?php echo $GLOBALS['kga']['dict']['export_extension']['print'] ?></span>
    ...
    <div class="floater_content">
        ...
        <form id="xpo_ext_form_print" action="../extensions/ki_export/processor.php" method="post" target="_blank">
            <fieldset>

                <ul>
                    <li>
                        <?php echo $GLOBALS['kga']['dict']['export_extension']['print_hint'] ?>
                    </li>
                    ...
                    <li>
                        ...
                        <input type="checkbox"
                               value="true"
                               name="print_summary"
                               id="print_summary" <?php if ($this->prefs['print_summary']): ?> checked="checked" <?php endif; ?>>
                    </li>
                    ...
                    <li>
                        ...
                        <input type="checkbox"
                               value="true"
                               name="reverse_order"
                               id="reverse_order" <?php if ($this->prefs['reverse_order']): ?> checked="checked" <?php endif; ?>/>
                    </li>
                </ul>
                ...
                <div id="formbuttons">
                    ...
                    <input class='btn_ok'
                           type='submit'
                           value='<?php echo $GLOBALS['kga']['dict']['submit'] ?>'
