<?php if (count($this->exportData) > 0): ?>
    ...
    <?php foreach ($this->exportData as $row):
        ...
        <td class="date<?php
        if (strftime("%d", $row['time_in']) != $day_buffer && $this->kga['show_daySeperatorLines']) {
            echo " break_day ";
        }
        elseif ($row['time_out'] != $time_in_buffer && $this->kga['show_gabBreaks']) {
            echo " break_gap ";
        }
        if (isset($this->disabled_columns['date'])) {
            echo " disabled ";
        }
        ?>">
        ...
        if (isset($this->disabled_columns['from'])) {
            echo " disabled ";
        }
        ?>">
        ...
        if (isset($this->disabled_columns['to'])) {
            echo " disabled ";
        }
        ?>">
        ...
        <td class="time<?php if (strftime("%d", $row['time_in']) != $day_buffer && $this->kga['show_daySeperatorLines']) {
            echo " break_day ";
        }
        elseif ($row['time_out'] != $time_in_buffer && $this->kga['show_gabBreaks']) {
            echo " break_gap ";
        }
        if (isset($this->disabled_columns['time'])) {
            echo " disabled ";
        } ?>">
        ...
        <td class="dec_time<?php if (strftime("%d", $row['time_in']) != $day_buffer && $this->kga['show_daySeperatorLines']) {
            echo " break_day ";
        }
        elseif ($row['time_out'] != $time_in_buffer && $this->kga['show_gabBreaks']) {
            echo " break_gap ";
        }
        if (isset($this->disabled_columns['dec_time'])) {
            echo " disabled ";
        } ?>">

            <?php if ($row['decimalDuration']) {
                echo $this->escape(str_replace('.', $this->kga['conf']['decimalSeparator'], $row['decimalDuration']));
            }
            else {
                echo "&ndash;:&ndash;&ndash;";
            } ?>
        ...
        if (isset($this->disabled_columns['rate'])) {
            echo " disabled ";
        }
        ?>">
        ...
        if (isset($this->disabled_columns['wage'])) {
            echo " disabled ";
        }
        ?>">
        ...
        if (isset($this->disabled_columns['budget'])) {
            echo " disabled ";
        }
        ?>">
        ...
        if (isset($this->disabled_columns['approved'])) {
            echo " disabled ";
        }
        ?>">
        ...
        if (isset($this->disabled_columns['status'])) {
            echo " disabled ";
        }
        ?>">
        ...
        if (isset($this->disabled_columns['billable'])) {
            echo " disabled ";
        }
        ?>">
        ...
        if (isset($this->disabled_columns['customer'])) {
            echo " disabled ";
        }
        ?>">
        ...
        <td class="project<?php if (strftime("%d", $row['time_in']) != $day_buffer && $this->kga['show_daySeperatorLines']) {
            echo " break_day ";
        }
        elseif ($row['time_out'] != $time_in_buffer && $this->kga['show_gabBreaks']) {
            echo " break_gap ";
        }
        if (isset($this->disabled_columns['project'])) {
            echo " disabled ";
        } ?>">

            <a href="#" class="preselect_lnk"
               onClick="buzzer_preselect_project(<?php echo $row['projectID'] ?>,'<?php echo $this->jsEscape($row['projectName']) ?>',<?php echo $row['customerID'] ?>,'<?php echo $this->jsEscape($row['customerName']) ?>');return false;">
                <?php echo $this->escape($row['projectName']) ?>
                <?php if ($this->kga['conf']['project_comment_flag'] == 1): ?>
                    <?php if ($row['projectComment']): ?>
                        <span class="lighter">(<?php echo $this->jsEscape($row['projectComment']); ?>)</span>
                    <?php endif; ?>
                <?php endif; ?>
            </a>
        </td>
        ...
        if (isset($this->disabled_columns['activity'])) {
            echo " disabled ";
        }
        ?>">
            <?php
            if (!$isExpense): ?>
            <a href="#" class="preselect_lnk"
               onClick="buzzer_preselect_activity(<?php echo $row['activityID'] ?>,'<?php echo $this->jsEscape($row['activityName']) ?>',0,0);return false;">
        ...
        if (isset($this->disabled_columns['comment'])) {
            echo " disabled ";
        }
        ?> ">
        ...
        <td class="comment<?php if (strftime("%d", $row['time_in']) != $day_buffer && $this->kga['show_daySeperatorLines']) {
            echo " break_day ";
        }
        elseif ($row['time_out'] != $time_in_buffer && $this->kga['show_gabBreaks']) {
            echo " break_gap ";
        ...
        if (isset($this->disabled_columns['location'])) {
            echo " disabled ";
        }
        ?>">
        ...
        if (isset($this->disabled_columns['trackingNumber'])) {
            echo " disabled ";
        }
        ?>">
        ...
        if (isset($this->disabled_columns['user'])) {
            echo " disabled ";
        }
        ?>">
        ...
        if (isset($this->disabled_columns['cleared'])) {
            echo " disabled ";
        }
        ?>">
