...
<div id="deb_ext_kga_header">
	<a href="#" title="Clear" onclick="deb_ext_reloadKGA();return false;"><img src="<?php echo $this->skin_dir . '/grfx/action_refresh.png'; ?>"  alt="Reload KGA"></a>
...
<?php if ($kga['delete_logfile']): ?>
        ...
        <a href="#" title="Clear" onclick="deb_ext_clearLogfile();return false;"><img src="../skins/<?php echo $kga['pref']['skin'] ?>/grfx/button_trashcan.png" width="13" height="13" alt="Clear"></a>
        </div>
<?php endif; ?>
