...
<div id="inv_ext_header">
    <strong><?php echo $GLOBALS['kga']['lang']['ext_invoice']['invoiceTitle'] ?></strong>
</div>
    ...
    <div id="invoice_extension">
        <form id="inv_ext_form" method="post" action="../extensions/ki_invoice/print.php" target="_blank">
            <div id="inv_ext_advanced">
                <div>
                    <label for="invoice_customerID"><?php echo $GLOBALS['kga']['lang']['customer'] ?>:</label>
                ...
                <div>
                    <label for="invoice_projectID"><?php echo $GLOBALS['kga']['lang']['project'] ?>:</label>
                ...
                <div>
                    <label><?php echo $GLOBALS['kga']['lang']['ext_invoice']['invoiceTemplate'] ?></label>
                ...
                <div>
                    <label for="defaultVat"><?php echo $GLOBALS['kga']['lang']['ext_invoice']['defaultVat'] ?>:</label>
                    <span
                        id="defaultVat"><?php echo $this->escape(
                            str_replace('.',
                                        ...
                                        $GLOBALS['kga']['conf']['vat_rate'])
                                          ...
                                          href="#">(<?php echo $GLOBALS['kga']['lang']['change'] ?>)</a>
                </div>
                <div>
                    <label for="short"><?php echo $GLOBALS['kga']['lang']['ext_invoice']['invoiceOptionShort'] ?></label>
                    <input type="checkbox" name="short" id="short" checked="checked">
                </div>
                <div>
                    <label for="round"><?php echo $GLOBALS['kga']['lang']['ext_invoice']['invoiceOptionRound'] ?></label>
                ...
                <div>
                    <label for="filter_cleared"><?php echo $GLOBALS['kga']['lang']['ext_invoice']['entryStatus'] ?></label>
                    <select name="filter_cleared" id="filter_cleared">
                        <option
                            value="-1" <?php if (!$GLOBALS['kga']['pref']['hide_cleared_entries']): ?> selected="selected" <?php endif; ?>><?php echo $GLOBALS['kga']['lang']['export_extension']['cleared_all'] ?></option>
                        <option
                            value="1"><?php echo $GLOBALS['kga']['lang']['export_extension']['cleared_cleared'] ?></option>
                        <option
                            value="0" <?php if ($GLOBALS['kga']['pref']['hide_cleared_entries']): ?> selected="selected" <?php endif; ?>><?php echo $GLOBALS['kga']['lang']['export_extension']['cleared_open'] ?></option>
                    </select>
                </div>
                <div style="border-bottom:none;">
                    <label for="invoice_button"></label>
                    <input type="submit" class="btn_ok" id="invoice_button"
                           value="<?php echo $GLOBALS['kga']['lang']['ext_invoice']['invoiceButton'] ?>">
                </div>
            </div>
        </form>
    </div>
