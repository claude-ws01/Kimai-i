    ...
    <div id="adm_ext_sub6">
        <div class="adm_ext_panel_header">
            <a onClick="adm_ext_subtab_expand(6)">
                ...
                <?php echo $GLOBALS['kga']['dict']['customers'] ?></a>
        </div>
    ...
    <div id="adm_ext_sub7">
        <div class="adm_ext_panel_header">
            <a onClick="adm_ext_subtab_expand(7)">
                <span class="adm_ext_accordeon_triangle"></span>
                <?php echo $GLOBALS['kga']['dict']['projects'] ?></a>
        </div>
    ...
    <div id="adm_ext_sub8">
        <div class="adm_ext_panel_header">
            <a onClick="adm_ext_subtab_expand(8)">
                <span class="adm_ext_accordeon_triangle"></span>
                <?php echo $GLOBALS['kga']['dict']['activities'] ?></a>
        </div>
    ...
    <div id="adm_ext_sub1">
        <div class="adm_ext_panel_header">
            <a onClick="adm_ext_subtab_expand(1)">
                <span class="adm_ext_accordeon_triangle"></span>
                <?php echo $GLOBALS['kga']['dict']['users'] ?></a>
        </div>
    ...
    <div id="adm_ext_sub2">
        <div class="adm_ext_panel_header">
            <a onClick="adm_ext_subtab_expand(2)">
                <span class="adm_ext_accordeon_triangle"></span>
                <?php echo $GLOBALS['kga']['dict']['groups'] ?></a>
        </div>
    ...
    <div id="adm_ext_sub9">
        <div class="adm_ext_panel_header">
            <a onClick="adm_ext_subtab_expand(9)">
                <span class="adm_ext_accordeon_triangle"></span>
                <?php echo $GLOBALS['kga']['dict']['globalRoles'] ?></a>
        </div>
    ...
    <div id="adm_ext_sub10">
        <div class="adm_ext_panel_header">
            <a onClick="adm_ext_subtab_expand(10)">
                <span class="adm_ext_accordeon_triangle"></span>
                <?php echo $GLOBALS['kga']['dict']['membershipRoles'] ?></a>
        </div>
    ...
    <div id="adm_ext_sub3">
        <div class="adm_ext_panel_header">
            <a onClick="adm_ext_subtab_expand(3)">
                <span class="adm_ext_accordeon_triangle"></span>
                <?php echo $GLOBALS['kga']['dict']['status'] ?></a>
        </div>
        ...
        <div id="adm_ext_sub4">
            <div class="adm_ext_panel_header">
                <a onClick="adm_ext_subtab_expand(4)">
                    <span class="adm_ext_accordeon_triangle"></span>
                    <?php echo $GLOBALS['kga']['dict']['advanced'] ?></a>
            </div>
        ...
        <div id="adm_ext_sub5">
            <div class="adm_ext_panel_header">
                <a onClick="adm_ext_subtab_expand(5)">
                    <span class="adm_ext_accordeon_triangle"></span>
                    <?php echo $GLOBALS['kga']['dict']['database'] ?></a>
            </div>
