        ...
        <fieldset class="adm_ext_advanced" style="padding-top:0;margin-top:0;">
            ...
            <div>
                <?php echo $kga['lang']['round_time'] ?> <select name="round_precision" class="formfield">
                    ...
                    <?php echo $kga['lang']['allow_round_down']; ?>
            </div>
            <div>
                <?php echo $kga['lang']['decimal_separator'] ?>:
            ...
            <div <?php if (!$this->edit_limit_enabled): ?> class="disabled" <?php endif; ?>>
                <input type="checkbox" name="edit_limit_enabled"
                       ...
                       class="formfield, disableInput"> <?php echo $kga['lang']['editLimitPart1'] ?>
                ...
                <?php echo $kga['lang']['editLimitPart2'] ?>
                <input type="text" name="edit_limit_hours" size="3" class="formfield"
                    ...
                    disabled="disabled" <?php endif; ?>> <?php echo $kga['lang']['editLimitPart3'] ?>
            </div>
            ...
            <div style="border-bottom:4px double #666;" <?php if (!$this->round_timesheet_entries): ?> class="disabled" <?php endif; ?>>
                ...
                <?php echo $kga['lang']['round_timesheet_entries'] ?>
                <input
                ...
                <?php echo $kga['lang']['minutes'] ?> <?php echo $kga['lang']['and'] ?>
                <input
            ...
            <div>
                ...
                <div>
                    ...
                    <?php echo $kga['lang']['rowlimit'] ?></div>

                <div>
                    <?php
                    echo $this->formSelect(
                        'ud_quickdelete', $kga['conf']['ud.quickdelete'], null,
                        array($kga['lang']['quickdeleteHide'],
                            $kga['lang']['quickdeleteShow'],
                            $kga['lang']['quickdeleteShowConfirm'])
                    ); ?>
                    <?php echo $kga['lang']['quickdelete'] ?> </div>
                ...
                <div>
                    ...
                    echo $kga['lang']['hide_cleared_entries'] ?>
                </div>
                ...
                <div>
                    ...
                    $kga['lang']['show_comments_by_default']; ?>
                </div>
                ...
                <div style="border-bottom:2px solid #666;" >
                    ...
                    echo $kga['lang']['hide_overlap_lines']
                    ?>
                </div>
                ...
                <div>
                    ...
                    echo $kga['lang']['user_list_hidden'];?>
                </div>
            </div>
