...
<div class="top">
    <a href="#" onClick="floaterShow('floaters.php','add_edit_customer',0,0,450); $(this).blur(); return false;"><img
            ...
            alt="<?php echo $kga['dict']['add_customer'] ?>"></a>
    <span><?php echo $kga['dict']['add_customer'] ?></span>
</div>
<table>
    ...
    if (!is_array($this->customers) || count($this->customers) === 0) {
        ...
        <tr class="<?php echo $this->cycle(array('odd', 'even'))->next() ?>">
            ...
            <td class="option">
                <a href="#"
                   onClick="editObject('customer',<?php echo $row['customer_id'] ?>); $(this).blur(); return false;"><img
            ...
            <td class="clients">
                <?php if ((int)$row['visible'] !== 1): ?><span
                    style="color:#bbb;"><?php endif; ?><?php echo $this->escape($row['name']); ?><?php if ((int)$row['visible'] !== 1): ?></span><?php endif; ?>
            </td>
