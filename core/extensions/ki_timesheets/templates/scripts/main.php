...
<div id="timeSheet_head">
    <div class="left">
        <?php if (isset($this->kga['user'])): ?>
            <a href="#"
               onClick="floaterShow('../extensions/ki_timesheets/floaters.php','add_edit_timeSheetEntry',selected_project+'|'+selected_activity,0,650); $(this).blur(); return false;"><?php echo $this->kga['lang']['add'] ?></a>
        <?php endif; ?>
    </div>
    <table>
        <colgroup>
        ...
        <tr>
            ...
            <?php if ($this->showRates): ?>
                <td class="wage"><?php echo $this->kga['lang']['ts_wage'] ?></td>
            <?php endif; ?>
            ...
            <?php } ?>
            <td class="username"><?php echo $this->kga['lang']['ts_user'] ?></td>
        </tr>
        </tbody>
    </table>
</div>
