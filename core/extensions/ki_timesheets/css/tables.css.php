...
#timeSheet_head td.customer,
#timeSheet_head td.project,
#timeSheet_head td.activity,
#timeSheet_head td.username,
#timeSheet td.customer,
#timeSheet td.project,
#timeSheet td.activity,
#timeSheet td.username
{
    padding-left: 2px;
    padding-right: 2px;
}
...
tbody tr.comm0 td {
    padding: 5px;
    background: #fff url('<?php echo $schraff0; ?>');
}

tbody tr.comm1 td {
    padding: 5px;
    background: #ff9 url('<?php echo $schraff1; ?>');
}

tbody tr.comm2 td {
    padding: 5px;
    background: #f00 url('<?php echo $schraff2; ?>');
    font-weight: bold;
    color: #fff;
}
