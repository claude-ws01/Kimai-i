...
function ts_ext_set_TableWidths() {
    ...
    var scr,
        ...
        tracking_number_head = ts_h_tbl.find("col.trackingnumber");
    ...
    if (tracking_number_head.width() != null) {
        tracking_number_head.css("width", ts_m_tr.find("td.trackingnumber").width());
    }
