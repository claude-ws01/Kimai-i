...
function ts_ext_set_TableWidths() {
    ...
    $("#timeSheet_head table").css("width", timeSheet_width - scr);

    // manage width of DATA column
    $("#timeSheet_head > table > tbody > tr > td.option").css("width", $("div#timeSheet > div > table > tbody > tr > td.option").width());
    $("#timeSheet_head > table > tbody > tr > td.date").css("width", $("div#timeSheet > div > table > tbody > tr > td.date").width());
    $("#timeSheet_head > table > tbody > tr > td.from").css("width", $("div#timeSheet > div > table > tbody > tr > td.from").width());
    $("#timeSheet_head > table > tbody > tr > td.to").css("width", $("div#timeSheet > div > table > tbody > tr > td.to").width());
    $("#timeSheet_head > table > tbody > tr > td.time").css("width", $("div#timeSheet > div > table > tbody > tr > td.time").width());
    $("#timeSheet_head > table > tbody > tr > td.wage").css("width", $("div#timeSheet > div > table > tbody > tr > td.wage").width());
    ...
    $("#timeSheet_head > table > tbody > tr > td.username").css("width", $("div#timeSheet > div > table > tbody > tr > td.username").width());
}
