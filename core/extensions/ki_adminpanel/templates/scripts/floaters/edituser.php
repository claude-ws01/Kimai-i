                ...
                <ul>
                    ...
                    <li>
                        ...
                        <?php if ($this->user_details['password'] == ""): ?>
                            ...
                            <br/>
                            <img
                                src="../skins/<?php echo $this->escape($this->kga['conf']['skin']) ?>/grfx/caution_mini.png"
                                alt="Caution" style="vertical-align:middle;"/>
                    ...
                    <li>
                        ...
                        <input class="formfield" type="text" id="rate" name="rate"
                               value="<?php echo $this->escape(str_replace('.', $this->kga['conf']['decimalSeparator'], $this->user_details['rate'])); ?>"/>
                    </li>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="deleteButton">
                                    <img
                                        src="../skins/<?php echo $this->escape($this->kga['conf']['skin']) ?>/grfx/close.png"
                                        width="22" height="16"/>
                                </a>
                            </td>
                        </tr>
