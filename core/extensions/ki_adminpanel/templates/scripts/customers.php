<a href="#" onClick="floaterShow('floaters.php','add_edit_customer',0,0,450); $(this).blur(); return false;"><img
        src="../skins/<?php echo $this->escape($this->kga['conf']['skin']) ?>/grfx/add.png" width="22" height="16"
        alt="<?php echo $this->kga['lang']['new_customer'] ?>"></a><?php echo $this->kga['lang']['new_customer'] ?>
<br/><br/>
    ...
    if (!is_array($this->customers) || count($this->customers) == 0) {
        ...
        foreach ($this->customers as $row) {
            ...
            <tr class="<?php echo $this->cycle(array("odd", "even"))->next() ?>">
                ...
                <td class="option">
                    <a href="#"
                       onClick="editSubject('customer',<?php echo $row['customerID'] ?>); $(this).blur(); return false;"><img
                    ...
                    <a href="#" id="delete_customer<?php echo $row['customerID'] ?>"
                       onClick="adminPanel_extension_deleteCustomer(<?php echo $row['customerID'] ?>)"><img
                            src="../skins/<?php echo $this->escape($this->kga['conf']['skin']) ?>/grfx/button_trashcan.png"
                            title="<?php echo $this->kga['lang']['delete_customer'] ?>" width="13" height="13"
                            alt="<?php echo $this->kga['lang']['delete_customer'] ?>" border="0"></a>
                </td>
