            ...
            foreach ($this->expenses as $row) {
                ...
                <tr id="expEntry<?php echo $row['expenseID'] ?>"
                    ...
                    <td style="white-space: nowrap" class="option
                        ...
                        elseif ($cur_timestamp_buffer != $timestamp_buffer && $this->kga['show_gabBreaks']) {
                            echo "break_gap";
                        } ?>">

                        <?php if (isset($this->kga['user']) && ($this->kga['conf']['editLimit'] == "-" || time() - $row['timestamp'] <= $this->kga['conf']['editLimit'])): ?>
                            <a href='#'
                               onClick="expense_editRecord(<?php echo $row['expenseID'] ?>); $(this).blur(); return false;"
                            ...
                            <?php if ($this->kga['conf']['quickdelete'] > 0): ?>
                                <a href='#' class='quickdelete'
                                   onClick="expense_quickdelete(<?php echo $row['expenseID'] ?>); return false;">
                                    <img
                                        ...
                                        title='<?php echo $this->kga['lang']['quickdelete'] ?>' border=0/>
                                </a>
                            <?php endif; ?>
                        <?php endif; ?>
                    ...
                    <td class="designation
                        ...
                        <?php if ($row['comment']): ?>
                            <?php if ($row['commentType'] == '0'): ?>
                                <a href="#"
                                   onClick="comment(<?php echo $row['expenseID'] ?>); $(this).blur(); return false;"><img
                ...
                if ($row['comment']) {
                    ?>
                    <tr id="expense_c<?php echo $row['expenseID'] ?>"
                        class="comm<?php echo $row['commentType'] ?>" <?php if ($this->hideComments): ?> style="display:none;"<?php endif; ?>>
