...
<div id="expenses_head">
    <div class="left">
        <?php if (isset($this->kga['user'])): ?>
            <a href="#"
               onClick="floaterShow('../extensions/ki_expenses/floaters.php','add_edit_record',0,0,600); $(this).blur(); return false;"><?php echo $this->kga['lang']['add'] ?></a>
        <?php endif; ?>
    </div>
    <table>
        <colgroup>
        ...
        <tr>
            ...
            <td class="value"><?php echo $this->kga['lang']['xp_expense'] ?></td>
            <td class="refundable"><?php echo $this->kga['lang']['xp_refundable'] ?></td>
            ...
            <td class="username"><?php echo $this->kga['lang']['xp_username'] ?></td>
        </tr>
        </tbody>
    </table>
</div>
